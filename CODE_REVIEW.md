...
You are an expert software engineer. Please apply the following changes to the C.H.E.T. codebase to fix the identified issues. For each issue, I will provide the file path and a diff in the Git merge format. Apply the changes exactly as described.
